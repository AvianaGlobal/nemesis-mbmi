""" A QSyntaxHighlighter that uses Pygments for parsing.

Original source: IPython project (BSD-licensed).
"""
...
class PygmentsHighlighter(QtGui.QSyntaxHighlighter):
    ...
    def __init__(self, parent, lexer='python', style='default'):
